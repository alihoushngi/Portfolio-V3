  ...
  return (
    <div className="h-[70vh] overflow-y-auto text-Appearance-Slate-400 px-4 text-justify max-md:text-left max-md:px-0">
      ...
      <p className="text-1 mb-4 max-md:text-xs">
        ...
        transitioned to web development, where I found my passion for creating{" "}
        <strong className="font-semibold">
      ...
      <p className="text-1 mb-4 max-md:text-xs">
        ...
        websites optimized for SEO and accessibility. My focus is on combining
      ...
      <p className="text-1 mb-4 max-md:text-xs">
        ...
        to helping clients achieve meaningful and lasting digital experiences.
      </p>
    </div>
  );
};
