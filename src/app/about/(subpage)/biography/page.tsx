...
const Biography = () => {
  return (
    <div className="biography h-[70vh] overflow-y-auto text-Appearance-Slate-400 px-6 text-left max-md:px-4 max-md:py-2">
      ...
      <p className="text-1 mb-4 max-md:text-xs">
        ...
        1378) in
        <strong className="font-semibold"> Rasht, Iran</strong>. From an early
        age, curiosity and a sense of adventure have been inseparable parts of
        who I am. My inquisitive nature led me to explore everything around me,
        whether it was disassembling my toys or experimenting with electronics
        at home. This same curiosity fueled my love for video games and early
        interest in technology. I even remember a time when my parents tried to
        make me study, but I cleverly turned a simple power cable into a playful
      ...
      <p className="text-1 mb-4 max-md:text-xs">
        ...
        experimentation and creative problem-solving. This mindset naturally led
      ...
      <p className="text-1 mb-4 max-md:text-xs">
        ...
        football remained a part of my life, I shifted my academic path towards{" "}
        <strong className="font-semibold">computer science</strong> thanks to my
        father’s guidance. This decision introduced me to like-minded friends
      ...
      <p className="text-1 mb-4 max-md:text-xs">
        ...
        <strong className="font-semibold">
          Computer Software branch at Chamran University of Technology, Rasht
        </strong>
        ...
        <strong className="font-semibold">Ayda</strong>, who is now my loving
        wife.
      </p>
      ...
      <p className="text-1 mb-4 max-md:text-xs">
        ...
        service, moved to <strong className="font-semibold">Tehran</strong> to
        start my professional career in web development. Today, I live
      ...
      <p className="text-1 mb-4 max-md:text-xs">
        ...
        strong foundation for understanding how systems operate. Eventually, I
        transitioned to{" "}
        <strong className="font-semibold">web development</strong> and design,
      ...
      <p className="text-1 mb-4 max-md:text-xs">
        ...
        , and sharing insights on web performance, modern development practices,
        and <strong className="font-semibold">SEO strategies</strong>. My goal
        is to combine creativity, technical expertise, and real-world experience
        to build solutions that leave a lasting impact on users and clients
        alike.
      </p>
