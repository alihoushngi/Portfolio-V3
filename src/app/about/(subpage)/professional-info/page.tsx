...
const ProfessionalInfo = () => {
  return (
    <div className="professional-info h-[70vh] overflow-y-auto text-Appearance-Slate-400 px-6 text-left max-md:px-4 max-md:py-2">
      ...
      <p className="text-1 mb-4 max-md:text-xs">
        ...
        and{" "}
        <strong className="font-semibold">CI/CD deployment strategies</strong>{" "}
        to ensure reliable, maintainable, and production-ready projects. I
        prioritize <strong className="font-semibold">SEO optimization</strong>,{" "}
        <strong className="font-semibold">performance tuning</strong>, and{" "}
        <strong className="font-semibold">accessibility compliance</strong> in
      ...
      <p className="text-1 mb-4 max-md:text-xs">
        ...
        reusable code that not only meets client requirements but is also easy
      ...
      <p className="text-1 mb-4 max-md:text-xs">
        ...
        and SEO best practices. My goal is to stay at the forefront of
        technology trends and continuously improve my craft to deliver
      ...
      <p className="text-1 mb-4 max-md:text-xs">
        ...
        developing fast-loading React apps to designing responsive WordPress
        solutions, my focus is always on delivering excellence and long-lasting
        digital experiences.
      </p>
    </div>
  );
